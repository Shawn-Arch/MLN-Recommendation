...
def cmd_kge(workspace_path, model):
    ...
    if model == 'TransE':
        return 'bash ./kge/kge.sh train {} {} 2 {} {} {} {} {} {} {} {} {} {}'.format(model, dataset, kge_batch, kge_neg, kge_dim, kge_gamma, kge_alpha, kge_lr, kge_iters, kge_tbatch, workspace_path, kge_topk)
    if model == 'DistMult':
...
time = '2021-03-02_19:54:56.796805'
path = path + '/' + time
ensure_dir(path)
